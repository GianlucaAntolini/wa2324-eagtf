<%@ page contentType="text/html;charset=utf-8" %>
	<%@ taglib prefix="c" uri="http://java.sun.com/jsp/jstl/core" %>
		...
		<body class="bg-2">
			...
			<main>
				<div class="flex-grow w-full pt-24 px-6 flex flex-col items-center">
					<h1 class="ranked-title text-4xl font-medium" style="font-family: Georgia, serif;">Rejected Recipes
					</h1>
					...
					<div id="contextMenu" class="context-menu" style="display:none">
						<ul>
							<li>
								<button type="submit" id="cmRecoverButton" class="cmButton2">
									<img src="media/img/recover.png" width="20px" height="20px">
									Recover
								</button>
							</li>
							<li>
								<button type="submit" id="cmRemoveButton" class="cmButton2">
									<img src="media/img/trash.png" width="20px" height="20px">
									Remove
								</button>
							</li>
						</ul>
					...
					<c:choose>
						<c:when test='${not empty recipesToBeRecoveredOrRemovedList}'>
							<p id="hiddentxt" style="display:none">No rejected recipe found in the database.</br></p>
							<div id="removable" class="container rounded-lg mx-auto px-4 overflow-x-auto">
								<div class="pb-2">
									<button type="submit" id="recoverButton"
										class="bg-4 text-white text-sm px-4 rounded-lg hover:bg-[#2a1b1b] h-8 px-3 mt-4">Recover</button>
									<span> </span>
									<button type="submit" id="removeButton"
										class="bg-4 text-white text-sm px-4 rounded-lg hover:bg-[#2a1b1b] h-8 px-3 mt-4">Remove</button>
								</div>
								<div class="inline-block min-w-full shadow rounded-lg overflow-hidden">
									<table id="myTable" class="min-w-full leading-normal">
										...
										<tbody>
											<c:forEach var="recipe" items="${recipesToBeRecoveredOrRemovedList}">
												<tr>
													<th scope="row"
						...
						<c:otherwise>
							<p>No rejected recipe found in the database.</br></p>
						</c:otherwise>
					</c:choose>
					<div class="px-4">
		...
		<script src="<c:url value='/js/recover-remover-recipes.js'/>"></script>
