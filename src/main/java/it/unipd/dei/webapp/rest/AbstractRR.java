...
public abstract class AbstractRR implements RestResource {
	 ...
	 */
	protected AbstractRR(final String action, final HttpServletRequest req, final HttpServletResponse res,
	 ...
	 *
	 * Subclasses have to implement this method in order to define the actual
	 * strategy for serving the REST request.
	 *
	 ...
	 *
	 * Subclasses may override it to customize their behaviour, e.g. not limiting
	 * the MIME media types to JSON.
	 *
	 * @param req the HTTP request.
	 * @param res the HTTP response.
	 *
	 * @return {@code true} if the request method and the MIME type are allowed;
	 *         {@code false} otherwise.
	 *
	 * @throws IOException if any error occurs in the client/server communication.
	 */
	protected boolean checkMethodMediaType(final HttpServletRequest req, final HttpServletResponse res)
			throws IOException {
