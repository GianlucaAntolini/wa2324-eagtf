...
import it.unipd.dei.webapp.dao.RemoveRecipeByIdDAO;
 ...
 * @since 1.00
 */
public final class RemoveRecipeRR extends AbstractRR {

    public RemoveRecipeRR(final HttpServletRequest req, final HttpServletResponse res, Connection con) {
    ...
    protected void doServe() throws IOException {
        ...
        try {
            ...
            status = (String) new RemoveRecipeByIdDAO(con, recipe_id).access().getOutputParam();

            LOGGER.info("Recipe successfully removed.");
            m = new Message("Recipe successfully removed.");
