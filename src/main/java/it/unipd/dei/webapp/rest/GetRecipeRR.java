...
/**
 * A REST resource for getting a Recipe resource.
 */
public final class GetRecipeRR extends AbstractRR {

    /**
     * Creates a new REST resource for getting a Recipe resource.
     *
     * @param req the HTTP request.
     * @param res the HTTP response.
     * @param con the connection to the database.
     */
    public GetRecipeRR(final HttpServletRequest req, final HttpServletResponse res, Connection con) {
