 ...
 * @since 1.00
 */
public final class RejectRecipeRR extends AbstractRR {

    public RejectRecipeRR(final HttpServletRequest req, final HttpServletResponse res, Connection con) {
    ...
    protected void doServe() throws IOException {
        ...
        try {
            ...
            LOGGER.info("Recipe successfully rejected.");
            m = new Message("Recipe successfully rejected.");
