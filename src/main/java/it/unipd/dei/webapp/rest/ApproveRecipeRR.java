...
import it.unipd.dei.webapp.dao.SetApprovedRecipeByIdDAO;
 ...
 * @since 1.00
 */
public final class ApproveRecipeRR extends AbstractRR {

    public ApproveRecipeRR(final HttpServletRequest req, final HttpServletResponse res, Connection con) {
    ...
    protected void doServe() throws IOException {
        ...
        try {
            ...
            approved = (Boolean) req.getAttribute("approved");

            status = (String) new SetApprovedRecipeByIdDAO(con, recipe_id, approved).access().getOutputParam();

            LOGGER.info("Recipe successfully approved.");
            m = new Message("Recipe successfully approved.");
