...
/**
 * Represents a generic Data Access Object (DAO). The {@link #access()} method
 * performs the actual access to the
 * database, while the {@link #getOutputParam()} allows for retrieving any
 * output parameters resulting from the access,
 * if any.
 *
