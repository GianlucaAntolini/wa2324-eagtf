...
/**
 * Searches for the recipes to be approved.
 */
public final class GetRecipesToBeApprovedDAO extends AbstractDAO<List<Recipe>> {

    /**
     * Load the queries from the query.xml file
     */
    private static final QueryLoader queryLoader = new QueryLoader();
    private static String STATEMENT1 = queryLoader.loadQuery("GetRecipesToBeApprovedQuery1");
    private static String STATEMENT2 = queryLoader.loadQuery("GetRecipesToBeApprovedQuery2");

    /**
     * Creates a new object for searching for recipes to be approved.
     *
     * @param con the connection to the database.
     */
    public GetRecipesToBeApprovedDAO(final Connection con) {
        super(con);
    }
