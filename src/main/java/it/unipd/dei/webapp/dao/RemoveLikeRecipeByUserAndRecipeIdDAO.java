...
/**
 * Remove a like given by a user to a recipe.
 */
public class RemoveLikeRecipeByUserAndRecipeIdDAO extends AbstractDAO<Object> {
    /**
     * Creates a new object for removing like given by user to a recipe.
     *
     * @param con       the connection to the database.
     * @param recipe_id the identifier of the recipe.
     * @param user_id   the identifier of the user.
     */
    public RemoveLikeRecipeByUserAndRecipeIdDAO(Connection con, String recipe_id, String user_id) {
        super(con);
    ...
    private static String STATEMENT = queryLoader.loadQuery("RemoveLikeRecipeByUserAndRecipeIdQuery");
    ...
    protected final void doAccess() throws SQLException {
        ...
        try {
            ...
            LOGGER.info("Recipe %d successfully unliked by user %d.", recipe_id, user_id);
