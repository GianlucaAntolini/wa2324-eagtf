...
public final class MailManager {
	 ...
	 */
	public static void sendMail(final String to, final String subject, final String message, final String messageMIME)
	 ...
	 * @param attachmentMIME     the MIME media type of the attachment to the
	 *                           e-mail.
	 * @param attachmentFileName the file name to assign to the attachment.
	 *
	 * @throws MessagingException if there is any problem in sending the e-mail.
	 */
	public static void sendAttachmentMail(final String to, final String subject, final String message,
			final String messageMIME, final byte[] attachment, final String attachmentMIME,
			final String attachmentFileName) throws MessagingException {
