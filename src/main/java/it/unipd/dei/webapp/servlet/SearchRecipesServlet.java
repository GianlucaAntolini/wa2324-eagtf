...
import it.unipd.dei.webapp.dao.GetRecipesFromIngTagDAO;
...
/**
 * Return an the list of the recipes searched based on the ingredient and tags
 * given from the user by get paramers
 */
public final class SearchRecipesServlet extends AbstractDatabaseServlet {
    ...
    public void doGet(HttpServletRequest req, HttpServletResponse res)
        ...
        LOGGER.info("new SearchRecipesServlet get request");
        ...
        try {
            ...
            if (usr_src_ing != null & usr_src_tag != null) {
                ...
                recipes = new GetRecipesFromIngTagDAO(getConnection(), ingredients, tags, size).access()
                        .getOutputParam();
                ...
                req.setAttribute("empty_table_message", "No recepies found ");
            ...
            // set the table name
            req.setAttribute("name_table", "Risultati della ricerca:");
            // stores the employee list and the message as a request attribute
            req.setAttribute("recipesList", recipes);
            req.setAttribute("message", m);

            req.getRequestDispatcher("/jsp/include/recipes_list_search.jsp").include(req, res);
