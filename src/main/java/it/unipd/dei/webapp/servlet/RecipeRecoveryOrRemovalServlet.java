...
import it.unipd.dei.webapp.dao.GetRecipesToBeRecoveredOrRemovedDAO;
...
/**
 * Get the list of rejected recipes and recover or remove them.
 */
public final class RecipeRecoveryOrRemovalServlet extends AbstractDatabaseServlet {

    /**
     * Get the list of rejected recipes and build the page.
     * 
     * @param req
    ...
    public void doGet(HttpServletRequest req, HttpServletResponse res)
        ...
        LogContext.setAction(Actions.SEARCH_RECIPES_TO_BE_RECOVERED_OR_REMOVED);
        ...
        try {
            ...
            // recipes
            recipes = new GetRecipesToBeRecoveredOrRemovedDAO(getConnection()).access().getOutputParam();
        ...
        try {
            ...
            req.setAttribute("recipesToBeRecoveredOrRemovedList", recipes);
            req.setAttribute("message", m);

            // forwards the control to the to-be-recovered-or-removed-recipes-list.jsp
            req.getRequestDispatcher("/jsp/to-be-recovered-or-removed-recipes-list.jsp").forward(req, res);
